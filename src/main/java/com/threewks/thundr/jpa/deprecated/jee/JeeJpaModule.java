...
public class JeeJpaModule implements Module {
	public static final String PersistenceManagerRegistry = String.format("thundr-jpa-%s", EntityManagerRegistryImpl.class);
	...
	public void configure(UpdatableInjectionContext injectionContext) {
		EntityManagerRegistry registry = initializePersistenceManagerRegistry(injectionContext);
	...
	protected final void registerActionInterceptorAnnotations(UpdatableInjectionContext injectionContext, EntityManagerRegistry entityManagerRegistry) {
		InterceptorRegistry actionInterceptorRegistry = injectionContext.get(InterceptorRegistry.class);
		actionInterceptorRegistry.registerInterceptor(JpaSession.class, new JpaSessionInterceptor(entityManagerRegistry));
	}

	protected final EntityManagerRegistry initializePersistenceManagerRegistry(UpdatableInjectionContext injectionContext) {
		EntityManagerRegistry registry = new EntityManagerRegistryImpl();
